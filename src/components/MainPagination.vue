...
<style scoped lang="postcss">
  .pagination {
    ...
    .action {
      @apply rounded-md bg-slate-100 p-2 font-medium text-slate-700 shadow-md hover:bg-slate-200 disabled:text-slate-300 hover:disabled:bg-slate-100;
    }
    .page {
      @apply rounded-md bg-blue-400 p-2 font-medium text-slate-700 shadow-md hover:bg-slate-100;
      &.active {
